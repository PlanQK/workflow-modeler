...
export default function EditorTab() {
  ...
  const [autoSaveFileOption, setAutoSaveFileOption] = useState(
    editorConfig.getAutoSaveFileOption()
  );
  ...
  const [autoSaveIntervalSize, setAutoSaveIntervalSize] = useState(
  ...
  EditorTab.prototype.onClose = () => {
    ...
    modeler
      .get("eventBus")
      .fire("autoSaveOptionChanged", { autoSaveFileOption });
        ...
        <tbody>
          <tr className="spaceUnder">
            ...
            <td align="left">
              ...
              >
                {Object.values(transformedWorkflowHandlers).map((value) => (
        ...
        <tbody>
          ...
          <tr className="spaceUnder">
            ...
            <td align="left">
              ...
              >
                {Object.values(saveFileFormats).map((value) => (
                  <option key={value} value={value}>
                    {value}
                  </option>
                ))}
        ...
        <tbody>
          <tr className="spaceUnder">
            ...
            <td align="left">
              ...
              >
                {Object.values(autoSaveFile).map((value) => (
                  <option key={value} value={value}>
                    {value}
                  </option>
                ))}
            ...
            <tr className="spaceUnder">
              ...
              <td align="left">
                <input
                  ...
                  onChange={(event) =>
                    setAutoSaveIntervalSize(event.target.value)
                  }
                />
              </td>
            </tr>
