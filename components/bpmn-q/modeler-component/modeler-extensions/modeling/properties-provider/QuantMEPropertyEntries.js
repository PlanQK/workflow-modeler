...
export function CalibrationMethodEntry({ element }) {
  ...
  const selectOptions = [
    {value: 'fullMatrix', name: 'Full Matrix'}, {value: 'tpnm', name: 'TPNM'}, {
      value: 'ctmp',
      name: 'CTMP'
    }, {value: 'ddot', name: 'DDOT'}, {value: 'conditionallyRigorous', name: 'Conditionally Rigorous'},
    {value: 'fuzzyCMeans', name: 'Fuzzy C-Means'}, {
      value: 'cumulantCM',
      name: 'Cumulant CM'
    }, {value: 'sclableTMatrix', name: 'Sclable T-Matrix'}
  ];
