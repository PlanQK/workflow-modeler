 ...
 * @param processContextVariables Array of process variables which should be published in process context
 ...
 */
function createGlobalProcessVariables(processContextVariables, rootProcess, definitions, modeler) {
