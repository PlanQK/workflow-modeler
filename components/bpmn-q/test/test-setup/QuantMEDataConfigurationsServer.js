...
const quantmeDataObjects = [
  {
    ...
    icon: {
      className: "dataflow-quantum-circuit-object-icon",
  ...
  },
  {
    ...
    groupLabel: "Result",
    icon: {
      className: "dataflow-result-object-icon",
  ...
  },
  {
    ...
    icon: {
      className: "dataflow-evaluation-result-object-icon",
  ...
  },
  {
    ...
    icon: {
      className: "dataflow-parametrization-object-icon",
  ...
  },
  {
    ...
    icon: {
      className: "dataflow-initial-state-object-icon",
