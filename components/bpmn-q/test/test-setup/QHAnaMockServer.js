  ...
  data: {
    ...
    items: [
      ...
      // },
      {
        ...
        rel: [],
        schema:
          "http://localhost:5000/api/api-spec.json#/components/schemas/Plugin",
      },
      {
        resourceType: "plugin",
        resourceKey: {
    ...
    self: {
      ...
      rel: ["collection", "page", "page-1", "first", "last"],
      schema:
        "http://localhost:5000/api/api-spec.json#/components/schemas/CursorPage",
    },
  },
  embedded: [
    {
      ...
      links: [
        {
          ...
          rel: ["collection", "up", "page", "page-1", "first"],
          schema:
            "http://localhost:5000/api/api-spec.json#/components/schemas/CursorPage",
        },
      ],
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/csv-visualization%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/distance-aggregator%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          dataInput: [],
          uiHref:
            "http://localhost:5005/plugins/hello-world-multi-step%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/hybrid-autoencoder%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/json-visualization%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/manual-classification%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          dataInput: [],
          uiHref:
            "http://localhost:5009/#algorithms?plugin-endpoint-url=http%3A%2F%2Flocalhost%3A5005%2Fplugins%2Fnisq-analyzer%2540v0-1-0%2F",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/one-hot%20encoding%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/qiskit-quantum-kernel-estimation%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        ...
        version: "v0.2.0",
        tags: ["qiskit", "qc-simulator", "qasm", "circuit-executor", "qasm-2"],
        self: {
          resourceType: "plugin",
          resourceKey: {
            pluginId: "17",
    ...
    },
    {
      data: {
        ...
        version: "v0.1.0",
        tags: ["k-means", "points-to-clusters"],
        self: {
          resourceType: "plugin",
          resourceKey: {
            pluginId: "18",
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/quantum-kernel-estimation%40v0-1-0/ui/",
          pluginDependencies: [],
    ...
    },
    {
      data: {
        entryPoint: {
          ...
          uiHref:
            "http://localhost:5005/plugins/sim-to-dist-transformers%40v0-1-0/ui/",
          pluginDependencies: [],
  ...
  links: [
    {
      ...
      rel: ["up"],
      schema:
        "http://localhost:5000/api/api-spec.json#/components/schemas/Root",
    },
    {
      resourceType: "plugin",
      resourceKey: {
