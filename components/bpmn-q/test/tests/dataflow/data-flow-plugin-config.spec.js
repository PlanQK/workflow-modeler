...
import * as dataConfig from "../../../modeler-component/extensions/dataflow/framework-config/DataConfigManager";
describe("Test DataFlow plugin config", function () {
  describe("Test plugin config of configurations endpoint", function () {
    ...
    it("Should configure configurations endpoints", function () {
      ...
      expect(dataConfig.getConfigurationsEndpoint()).to.equal(
        "http://test:5006/configs"
      );
    });
