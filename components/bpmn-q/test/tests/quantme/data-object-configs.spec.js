...
import {
    instance as dataObjectConfigurationsEndpoint
} from '../../../modeler-component/extensions/quantme/configurations/DataObjectConfigurations';
...
describe('Test DataObjectConfigurations', function () {
    ...
    before('Init ConfigurationEndpoint', function () {
        ...
        fetchStub = sinon.stub(dataObjectConfigurationsEndpoint(), 'fetchConfigurations').callsFake(() => {
            dataObjectConfigurationsEndpoint()._configurations = QUANTME_DATA_OBJECTS;
        });
    ...
    describe('Test getQuantMEDataConfigurations()', function () {
        ...
        it('should return all data object configurations', function () {
            ...
            const configurations = dataObjectConfigurationsEndpoint().getQuantMEDataConfigurations();
    ...
    describe('Test getQuantMEDataConfiguration()', function () {
        ...
        it('should return configuration for ResultObject', function () {
            ...
            const configuration = dataObjectConfigurationsEndpoint().getQuantMEDataConfiguration('Result-Object');
        ...
        it('should return no configuration', function () {
            ...
            const configuration = dataObjectConfigurationsEndpoint().getQuantMEDataConfiguration('Undfined-Id');
